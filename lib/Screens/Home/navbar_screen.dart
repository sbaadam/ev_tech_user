        ...
        children: [
          ...
          Positioned.fill(
            child: Padding(
              ...
              child: pages[selectedIndex == 4 ? 4 : selectedIndex],
            ),
          ),
          // Bottom Bar with space for SOS button
          Positioned(
            left: 0,
            right: 0,
            bottom: 0,
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                _buildNavItem(icon: ImageConstant.homeSvg, index: 0),
                _buildNavItem(icon:ImageConstant.gridSvg, index: 1),
                const SizedBox(width: 60),
                _buildNavItem(icon: ImageConstant.listSvg, index: 2),
                _buildNavItem(icon: ImageConstant.userSvg, index: 3),
              ],
            ),
          ),
  ...
  Widget _buildNavItem({required String icon, required int index}) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppTheme.greenColor40 : Colors.transparent,
          shape: BoxShape.circle,
        ),
        child: SvgPicture.asset(icon,height: 10,width: 10,)
      ),
    );
  }
}